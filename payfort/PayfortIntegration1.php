...
class PayfortIntegration {
     ...
     */
        ...
        public $merchantIdentifier = 'jlTyHcAY'; //Test : OBUUJAmg,     Live : 

            /**
             * @var string your access code
             */
            public $accessCode = 'ldsSjhXXNAm1V8yxdRVL'; //Test : d4kkzMbQuQKLTLhWFWIo,    Live : 
        
            /**
             * @var string SHA Request passphrase
             */
            public $SHARequestPhrase = 'TESTSHAIN'; //Test : $2y$10$7Fm6yj4OF,    Live : 
        
            /**
             * @var string SHA Response passphrase
             */
            public $SHAResponsePhrase = 'TESTSHAOUT'; //Test : HuT6L8vNN7,   Live : 
...
//
//            $debugMsg = "merchentPageData \n" . print_r(array('data' => $paymentMethod,'userid' => $userId), 1);
//            $this->log($debugMsg);
...
//        $form .= '<input type="hidden" name="remember_me" value="YES">';
...
//            unset($params['remember_me']);
    ...
    public function PaymentReqeust($fortParams) {
        ...
        $debugMsg = "Fort payment Parameters response \n" . print_r($array_result, 1);
        $this->log($debugMsg);
        return $array_result;
...
//          return array('postdata' => $postData,'response' => $array_result);
    ...
    public function refundAuthAmount($fortParams) {
