...
function getProductsByStoreId(data, callback) {
...
module.exports = { getProductsByStoreId, Select, SelectAll, Insert, Update, updateByQuery, Delete, UpdateWithPush, UpdateWithPull };