...
/** @namespace */
const addOnDelete = require('./delete');
...
module.exports = [

    {
        ...
        config: {
            tags: ['api', 'admin'],
            description: 'Api for updating addOnDelete ',
            notes: 'Api for update addOnDelete.',
            auth: false,
            validate: {
                /** @memberof validator */
                payload: addOnDelete.validator,
                /** @memberof language */
