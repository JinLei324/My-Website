...
/** @namespace */
const updateBrand = require('./patch');
...
module.exports = [

    {
        ...
        config: {
            tags: ['api', 'admin'],
            description: 'Api for updating the brand',
            notes: 'Api for updating the brand.',
            auth: false,
            validate: {
                /** @memberof validator */
                payload: updateBrand.validator,
                /** @memberof language */
