    ...
    */
    {
        ...
        config: {
            ...
            response: {
                status: {
                    200: {
                        message: Joi.any().default(i18n.__('vouchers')['200'])
                    },
                    404: {
                        message: Joi.any().default(i18n.__('vouchers')['404'])
                    },
                    500: {
