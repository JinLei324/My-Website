            ...
            cart.isExists({ userId: request.auth.credentials._id.toString() }, (err, data) => {
                ...
                if (data) {
                    ...
                    cart.postSave({
                        ...
                        mileageMetric: zoneData.mileageMetric,
                        currencySymbol: storeData.currencySymbol ? storeData.currencySymbol : zoneData.currencySymbol, currency: storeData.currency ? storeData.currency : zoneData.currency, userId: request.auth.credentials._id.toString(), unitId: request.payload.unitId, unitName: request.payload.unitName, customerName: customerData.name, city: zoneData.city, cityId: storeData.cityId, childProductId: request.payload.childProductId, parentProductId: productData.parentProductId, storeId: storeData._id.toString(), storeName: storeData.sName[request.headers.language], storeAddress: storeData.storeAddr ? storeData.storeAddr : "", storeLogo: storeData.profileLogos ? storeData.profileLogos.logoImage : "", storePhone: storeData.bcountryCode ? storeData.bcountryCode + storeData.businessNumber : "", sku: productData.sku, itemName: productData.productname[request.headers.language], upc: productData.upc, itemImageURL: productData.images &&productData.images.length>0  ? productData.images[0]['image'] : '', quantity: request.payload.quantity,
