...
/** @namespace */
const i18n = require('../../../../../../locales/locales');/** @namespace */
const forgotPassword = require('./post');
/**
* A module that exports Customer API  routes to hapi server!
* @exports DISPATCHER-FORGOT-PASSWORD-API-ROUTES 
*/
module.exports = [
    ...
    {
        method: 'POST',
        path: '/dispatcher/forgotPassword',
        config: {
            tags: ['api', 'dispatcher'],
            ...
            response: {
                status: {
                    200: { message: Joi.any().default(i18n.__('supportForgotPassword')['200']) , data : Joi.any() },
