...
const handler = (request, reply) => {
    ...
    var childProductId = request.payload.childProductId
    var unitId = request.payload.unitId
    if (request.payload.orderType && request.payload.orderType == 2) {

        childProductId = parseInt(request.payload.childProductId)
        unitId = parseInt(request.payload.unitId)
    }
