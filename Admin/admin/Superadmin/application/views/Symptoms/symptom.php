...
<script>
    ...
    //   base_url().'index.php?/superadmin/access_denied';
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url() ?>index.php?/SymptomController/data_details/1',
            "bJQueryUI": true,
        ...
        $('#add').click(function () {
            ...
            $(this).closest('form-group').find("input[type=text], textarea").val("");
            if (val.length == 0) {
        ...
        $("#yesAdd").click(function () {
            ...
            if (bname == '' || bname == null)
            {
                ...
                $.ajax({
                    url: "<?php echo base_url('index.php?/SymptomController') ?>/addBrand",
                    type: "POST",
                    dataType: 'json',
                    data: {symptomName: Name, brandDescription: Description, bannerImage: bimg},
                    success: function (result) {
                        console.log('--------',result)
                        if (result.flag == 1) {
                            $('#addModal').modal('hide');
...
//        $('#edit').click(function () {
        $(document).on('click', '#btnEdit', function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/SymptomController') ?>/getBrand",
                type: "POST",
                dataType: 'json',
                data: {Id: editval},
                success: function (result) {
...
<?php } ?>
        ...
        $("#yesEdit").click(function () {
            ...
            if (Bname == '' || Bname == null)
            {
                ...
                $.ajax({
                    url: "<?php echo base_url('index.php?/SymptomController') ?>/editBrand",
                    type: "POST",
                    data: {Id: editval, symptomName: Name, brandDescription: Desc,bannerImage: editbimg,logoImage: editlogoimg},
                    success: function (result) {
                        console.log(result);
                        if (result == "true") {
        ...
        $("#activate").click(function () {
           ...
           $("#delete").click(function () {
            ...
            if (val.length >= 1) {
                ...
                $("#errorboxactivate").text('Are you sure you want to Delete.?');
        ...
        $("#yesActivate").click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/SymptomController') ?>/activateBrand",
                type: "POST",
                data: {Id: val},
                success: function (result) {
                    ...
                    if (res.flag == 0) {
                        ...
                        var settings = {
                            ...
                            "bProcessing": true,
                            "bServerSide": true,
                            "sAjaxSource": '<?php echo base_url() ?>index.php?/SymptomController/data_details/0',
                            "bJQueryUI": true,
                            "sPaginationType": "full_numbers",
                            "iDisplayStart ": 20,
                            "oLanguage": {
        ...
        $('#yesdeactivate').click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/SymptomController') ?>/deactivateBrand",
                type: "POST",
                data: {Id: val},
                success: function (result) {
           ...
           $('#yesDelete').click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php?/SymptomController') ?>/deleteSymtom",
                type: "POST",
                data: {Id: val},
                success: function (result) {
                    console.log(JSON.parse(result));
        ...
        <div class="panel panel-transparent ">
            ...
            <ul class="nav nav-tabs  bg-white whenclicked">
                <li id= "my1" class="tabs_active active" style="cursor:pointer">
                    <a  class="changeMode accepted_" data="<?php echo base_url(); ?>index.php?/SymptomController/data_details/1" data-id="1"><span><?php echo $this->lang->line('heading_active'); ?></span><span class="badge" style="background-color: #337ab7;"></span></a>
                </li>

                <li id= "my2" class="tabs_active" style="cursor:pointer">
                    <a  class="changeMode rejected_" data="<?php echo base_url(); ?>index.php?/SymptomController/data_details/0" data-id="0"><span><?php echo $this->lang->line('heading_deactive'); ?></span> <span class="badge bg-red"></span></a>
                </li>

                  <li id= "my3" class="tabs_active" style="cursor:pointer">
                    <a  class="changeMode deleted_" data="<?php echo base_url(); ?>index.php?/SymptomController/data_details/2" data-id="0"><span><?php echo $this->lang->line('heading_delete'); ?></span> <span class="badge bg-red"></span></a>
                </li>
				
				  <div class="pull-right m-t-10"> <button style="margin-top:10px;" class="btn btn-info cls111" id="deactivate"><?php echo $this->lang->line('button_deactivate'); ?></button></div>
                <div class="pull-right m-t-10"> <button style="margin-top:10px;" class="btn btn-info cls111" id="activate"><?php echo $this->lang->line('button_activate'); ?></button></div>
                <div class="pull-right m-t-10"> <button style="margin-top:10px;" class="btn btn-danger cls111" id="delete"><?php echo $this->lang->line('button_delete'); ?></button></div>
                <div class="pull-right m-t-10"> <button style="margin-top:10px;" class="btn btn-success pull-right m-t-10 cls110" id="add"><?php echo $this->lang->line('button_add'); ?> </button></a></div>
            </ul>
            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                 <form id="addSymptomn">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="fname" class="col-sm-5 control-label">Image</label>
                        <div class="col-sm-6">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="fname" class="col-sm-5 control-label">Banner Image</label>
                        <div class="col-sm-6">
...
<div class="modal fade stick-up" id="deleteModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="error-box" id="errorboxactivate" style="text-align:center;font-size: 14px;">Are you sure you want to Delete.?</div>
                </div>
            </div>
            <br>
            <div class="modal-footer">
                ...
                <div class="col-sm-8">
                    <button type="button" data-dismiss="modal" class="btn btn-default btn-cons" id="cancel5"><?php echo $this->lang->line('button_Cancel'); ?></button>
                    <div class="pull-right m-t-10"> <button type="button" class="btn btn-success pull-right" id="yesDelete" ><?php echo $this->lang->line('button_delete'); ?></button></div>
                </div>
            </div>
        </div>
        <!-- /.modal-content -->
