...
<div class="content">
    ...
    <ul class="breadcrumb" style="padding: 10px 5px;background: white;">
            <li>
                <a class="active" href="<?= base_url() ?>index.php?/helpText/helpTextStore">Store Help Text</a>
            </li>
            <li>
                <a href="#" class="active">
                  Edit
        ...
        <div class="container-md-height m-b-20">
            <div class="panel panel-default" style="border:0;">
                <form action="<?= base_url() ?>index.php?/helpText/support_actionStore" method='post' novalidate>
                                    ...
                                    foreach ($language as $val) {
                                        ...
                                        <div class='col-sm-3'>
                                            <div class="checkbox check-success <?= $landis ?>">
                                                <input <?= $s ?> type="checkbox" class='lan_check' value="<?= $val['langCode'] ?>" id="checkbox<?= $val['langCode'] ?>" data-id='<?= $val['lan_name'] ?>' <?= $landis ?>>
