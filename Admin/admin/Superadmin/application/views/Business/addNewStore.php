            ...
            geocoder.geocode({'latLng': marker.getPosition()}, function (results, status) {
                if (status == google.maps.GeocoderStatus.OK) {
                    if (results[0]) {
                        ...
                        console.log('mapBtnDataId----',forAddress)
                        console.log('lat-----3');
...
<script>
    $(document).ready(function () {
          ...
          //$(".numbervalidation").autoNumeric();

        //   freelancer auto dispatch settings
...
//            console.log(countryData.dialCode);
        ...
        $('#insert').click(function () {
            ...
            var timeFee = $('#timeFee').val().replace( /,/g, "" );
            ...
            console.log('-',scheduledBookingsCancellationFeeAfterMinutes);
                        ...
                        <div class="tab-content">
                                ...
                                <div class="row row-same-height">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div id="foodtypeid" class="form-group" style="display:none">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="radio" checked class="foodtype" name="foodtype" id="" value="1" >&nbsp;&nbsp;<label><?php echo "VEG"; ?></label> 
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio"  class="foodtype" name="foodtype" id="" value="2" >&nbsp;&nbsp;<label><?php echo "NON-VEG"; ?></label> 
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio"  class="foodtype" name="foodtype" id="" value="3" >&nbsp;&nbsp;<label><?php echo "BOTH"; ?></label> 
                                        </div>
                                    </div>
                            ...
                            <section class="" id="tab2">
                                <div class="row row-same-height">
                                    ...
                                    <div class="form-group" >
                                        <label for="fname" class="col-sm-2 control-label error-box-class"><?php echo $this->lang->line('label_DriverType'); ?><span style="color:red;font-size:12px;">*</span></label>
                                        <div class="col-sm-6">
                                            <input type="radio" checked class="drivers_" name="select_driver" id="grocerDriver" value="2" >&nbsp;&nbsp;<label><?php echo $this->lang->line('label_DispensaryPool'); ?></label> 
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio"  class="drivers_" name="select_driver" id="storeDriver" value="1" >&nbsp;&nbsp;<label><?php echo $this->lang->line('label_Freelance'); ?></label> 
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="radio" class="pricing_ error-box-class" name="price" value="0" checked >&nbsp;&nbsp;<label><?php echo $this->lang->line('label_zonalPricing'); ?></label> 
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-2 pos_relative2">
                                            ...
                                            <input type="text" class="form-control error-box-class numbervalidation" data-v-max="9999999999.99" data-m-dec="2" id="entiryminorderVal" value='' onkeypress="return isNumberKey(event)" placeholder="Minimum Order Value" name="MinimumOrderValue"  aria-required="true" <?PHP echo $enable; ?>>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-2 pos_relative2">
                                            <span class="abs_text currencySymbol"><b><?php echo $appConfig['currency']; ?></b></span>
                                            <input type="text" class="form-control error-box-class numbervalidation" data-v-max="9999999999.99" data-m-dec="2" id="freedelVal" onkeypress="return isNumberKey(event)" placeholder="Threshold Value" name="FreeDeliveryAbove"  aria-required="true" <?PHP echo $enable; ?>>
                                        </div>
                                    ...
                                    <div class="form-group pos_relative2">
                                        ...
                                        <div class="col-sm-2 pos_relative2">
                                            ...
                                            <input type="text" class="form-control error-box-class" id="avgDeliveryTime" value='' onkeypress="return isNumberKey(event)" placeholder="Avg Delivery Time" name="avgDeliveryTime"  aria-required="true" <?PHP echo $enable; ?>>
                                        </div>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-6" id="accepts" >
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio" name="Accepts" onclick="acceptselect();" class="accepts error-box-class" id="accepts_3" value="3" checked><label><?php echo $this->lang->line('label_Both'); ?> </label>
                                        </div>
                                        <div class="col-sm-3 error-box" id="text_accepts" style="color:red;"></div>
                                    </div>
                                    <!-- recommanded for consumption -->
                                    <!-- <hr> -->
                                    <h6 class="textAlign" style="display:none"><?php echo $this->lang->line('CONSUMPTIONTIME'); ?></h6>
                                    <!-- <hr> -->

                                    <div class="form-group" style="display:none">
                                    <label class="checkbox-inline">
                                    <input type="checkbox" class="consumptionTime" value="breakfast"><span style="margin-left: 20px;font-weight: 700;">Breakfast </span></label>
                                   
                                    <label class="checkbox-inline">
                                    <input type="checkbox" class="consumptionTime" value="brunch"><span style="margin-left: 20px;font-weight: 700;">Brunch </span></label>
                                   
                                    <label class="checkbox-inline">
                                    <input type="checkbox" class="consumptionTime" value="lunch"><span style="margin-left: 20px;font-weight: 700;">lunch</span></label>
                                    <label class="checkbox-inline">
                                    <input type="checkbox" class="consumptionTime" value="tea"><span style="margin-left: 20px;font-weight: 700;">Tea And Snack</span></label>
                                    <label class="checkbox-inline">
                                    <input type="checkbox" class="consumptionTime" value="dinner"><span style="margin-left: 20px;font-weight: 700;">Dinner</span></label>
                                    <label class="checkbox-inline">
                                    <input type="checkbox" class="consumptionTime" value="latenightdinner"><span style="margin-left: 20px;font-weight: 700;">Late Night Dinner</span></label>
                                  
                                    </div>

                                   
                                    <!-- recommanded for consumption end -->
                                    <hr>
                                ...
                                <div class="row row-same-height">
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <input type="text" name="pricing[baseFare]" id="baseFare" placeholder="Enter Base Fare" class="form-control required numbervalidation" data-v-max="9999999999.99" data-m-dec="2">
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-2">
                                            <span class="abs_text1 currencySymbol"><b><?php echo $appConfig['currency']; ?></b></span>
                                            <input type="text" name="pricing[mileagePrice]" id="mileagePrice" placeholder="Enter Mileage Price" class="form-control required numbervalidation" data-v-max="9999999999.99" data-m-dec="2">
                                        </div>
                                        <div class="col-sm-2">
                                            <span class="abs_textLeft"><b>After</b></span>
                                            <input type="text" name="pricing[mileagePriceAfterMinutes]" id="mileagePriceAfter" value="0" style="padding-left: 49px;" class="form-control required numbervalidation" data-v-max="9999999999.99" data-m-dec="2">
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-2">
                                            <span class="abs_text1 currencySymbol"><b><?php echo $appConfig['currency']; ?></b></span>
                                            <input type="text" name="pricing[timeFee]" id="timeFee" placeholder="Enter Time Fee" class="form-control required numbervalidation" data-v-max="9999999999.99" data-m-dec="2">
                                        </div>
                                        <div class="col-sm-2">
                                            <span class="abs_textLeft"><b>After</b></span>
                                            <input type="text" name="pricing[timeFeeAfterMinutes]" style="padding-left: 49px;" value="0" id="timeFeeAfter" onkeypress="return isNumberKey(event)" placeholder="Enter time fare" class="form-control required " >
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-2">
                                            <span class="abs_text1 currencySymbol"><b><?php echo $appConfig['currency']; ?></b></span>
                                            <input type="text" name="pricing[waitingFee]" value="0" id="waitingFee" placeholder="Enter Waiting Fee" class="form-control required numbervalidation" data-v-max="9999999999.99" data-m-dec="2">
                                        </div>
                                        <div class="col-sm-2">
                                            <span class="abs_textLeft"><b>After</b></span>
                                            <input type="text" value="0" name="pricing[waitingFeeAfterMinutes]" style="padding-left: 49px;"  onkeypress="return isNumberKey(event)" id="waitingFeeAfter" class="form-control required " data-v-max="9999999999.99" data-m-dec="2">
                                            <span class="abs_text1"><b><?php echo $this->lang->line('Minutes'); ?></b></span>
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-2">
                                            <span class="abs_text1 currencySymbol"><b><?php echo $appConfig['currency']; ?></b></span>
                                            <input type="text" name="pricing[minimumFare]" id="minimumFare" placeholder="Enter Minimum Fare" class="form-control required numbervalidation" data-v-max="9999999999.99" data-m-dec="2">
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-2">
                                            <span class="abs_text1 currencySymbol"><b><?php echo $appConfig['currency']; ?></b></span>
                                            <input type="text" name="pricing[onDemandBookingsCancellationFee]" id="onDemandBookingsCancellationFee" placeholder="Enter Now Booking Cancellation Fee" class="form-control required numbervalidation" >
                                        </div>
                                        <div class="col-sm-2">
                                            <span class="abs_textLeft"><b>After</b></span>
                                            <input type="text" style="padding-left: 49px;" value="0" name="pricing[onDemandBookingsCancellationFeeAfterMinutes]"   onkeypress="return isNumberKey(event)" id="onDemandBookingsCancellationFeeAfter" class="form-control required " >
                                            <span class="abs_text1"><b><?php echo $this->lang->line('Minutes'); ?></b></span>
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-2">
                                            <span class="abs_text1 currencySymbol"><b><?php echo $appConfig['currency']; ?></b></span>
                                            <input type="text" name="pricing[scheduledBookingsCancellationFee]" id="ScheduledBookingsCancellationFee" placeholder="Enter Scheduled Booking Cancellation Fee" class="form-control required numbervalidation" data-v-max="9999999999.99" data-m-dec="2">
                                        </div>
                                        <div class="col-sm-2">

                                            <span class="abs_textLeft"><b>After</b></span>
                                            <input type="text" style="padding-left: 49px;" value="0" name="pricing[ScheduledBookingsCancellationFeeAfterMinutes]"   onkeypress="return isNumberKey(event)" id="ScheduledBookingsCancellationFee"  class="form-control required numbervalidation" >
                                            <span class="abs_text1"><b><?php echo $this->lang->line('Minutes'); ?></b></span>
                                        </div>
                                    </div>
                                    <div class="form-group required">
  ...
  <div class="modal fade" id="myModalerror" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Unable to add Store Please try again later..!</p>
        </div>
        <div class="modal-footer">
