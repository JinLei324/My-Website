...
//   });
    ...
    function phoneValidationCheck(phone, coutryCode)
    {
        ...
        var status = '1';
        $.ajax({
            url: "<?php echo base_url(); ?>index.php?/superadmin/validateMobileNo",
            type: "POST",
...
//            pstatus = false;
//        } else
           if (city_select == "" || city_select == null)
       {
           $("#ve_store").text('Please select a city');
           pstatus = false;
       } else 
...
//here this function validates all the field of form while adding new subadmin you can find all related functions in RylandInsurence.js file
    ...
    function submitform()
    {
        if (($('.checkbox:checked').val() == '' || $('.checkbox:checked').val() == null)) {
                $("#text_zone").text("");
                $("#zoneerrorbox").html("");
                $("#text_zone").text("Please select the Zone");
                $('#finishbutton').show();
            }else{
...
<div class="page-content-wrapper">
    ...
    <ul class="breadcrumb" style="margin-left: 0px; margin-top: 5%;">
        <li><a
                href="<?php echo base_url(); ?>index.php?/superadmin/Drivers/my/1"
                class=""><?php echo LIST_DRIVER; ?></a></li>
    ...
    <div class="content">
                    ...
                    <ul
                        ...
                        <li class="active tabs_active" id="firstlitab"
                            onclick="managebuttonstate()"><a data-toggle="tab" href="#tab1"
                                                         id="tb1"><i id="tab1icon" class=""></i> <span><?php echo LIST_DRIVER_PESIONALDETAILS; ?></span></a>
                        </li>
                        <li class="tabs_active" id="secondlitab"><a data-toggle="tab"
                                                                    href="#tab2" onclick="profiletab('secondlitab', 'tab2')"
                                                                    id="mtab2"><i id="tab2icon" class=""></i> <span><?php echo LIST_DRIVER_LOGINDETAILS; ?></span></a>
                        </li>
                        <li class="tabs_active" id="thirdlitab"><a data-toggle="tab"
                                                                   href="#tab3" onclick="addresstab('thirdlitab', 'tab3')"><i
                                    id="tab3icon" class=""></i> <span><?php echo LIST_DRIVER_DRIVINGLICENCE; ?></span></a>
                        </li>
                        <li class="tabs_active" id="fourthlitab"><a data-toggle="tab"
                                                                    href="#tab4" onclick="bonafidetab('fourthlitab', 'tab4')"><i
                                    id="tab4icon" class=""></i> <span>PREFERRED ZONES</span><span style="" class="MandatoryMarker"> *</span></a></li>
        ...
        <a data-toggle="tab" href="#tab5" onclick="fifthTab('fourthlitab','tab5')"><i id="tab5icon" class=""></i> <span>BANK DETAILS</span></a>
                    ...
                    <form id="addentity" class="form-horizontal" role="form"
                          action="<?php echo base_url(); ?>index.php?/superadmin/AddNewDriverData"
                            ...
                            <div class="tab-pane padding-20 slide-left active" id="tab1">
                                <div class="row row-same-height">
                                    ...
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label">City<span style="" class="MandatoryMarker"> *</span>
                                        </label>
                                        <div class="col-sm-6">
                                            ...
                                            <input type="hidden" id="driverType" value="1" name="driverType" required="required" class="form-control">
                                        </div>
...
//                                                }
                                    ?>
                                                                                </select> <input type="hidden" id="storeName" name="storeName" required="required" class="form-control">
                                                                            </div>
                                                                            <div class="col-sm-3 error-box" id="ve_store"></div>
                                    ...
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo FIELD_DRIVERS_FIRSTNAME; ?><span
                                    ...
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label">Date of
                                            Birth<span style="" class="MandatoryMarker"> *</span>
                                        </label>
                                        <div class="col-sm-6">

                                            <input type="text" id="dob" name="dob" required="required" readonly class="form-control datepicker-component1" >

                                        </div>
                                        <div class="col-sm-3 error-box" id="dobErr"></div>
                                    </div>

                                    <div class="form-group planSelect" >
                                        <label for="" class="control-label col-sm-2">Plan</label>
                                        <div class="col-sm-6">
                                            <select class="form-control" id="plan" name="plan">
                                                <option value="">Select</option>
                                                <?php
                                                foreach ($plans as $each) {
                                                    echo "<option value='" . $each['_id']['$oid'] . "' plan='" . $each['planName'] . "'>" . $each['planName'] . "</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="address" class="col-sm-2 control-label"><?php echo FIELD_DRIVERS_UPLOADPHOTO; ?><span
                                                style="" class="MandatoryMarker"> *</span></label>
                                        <div class="col-sm-5">
                            ...
                            <div class="tab-pane slide-left padding-20" id="tab2">
                                <div class="row row-same-height">
                                    ...
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo FIELD_DRIVERS_EMAIL; ?><span
                                                style="" class="MandatoryMarker"> *</span></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo FIELD_DRIVERS_PASSWORD; ?><span
                                                style="" class="MandatoryMarker"> *</span></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo FIELD_DRIVERS_MOBILE; ?><span
                                                style="" class="MandatoryMarker"> *</span></label>

                                        <div class="col-sm-6">
                                            <input type="tel" data="1" id="mobile" minlength="4" maxlength="15" name="mobile"
                                                   required="required" class="form-control"
                            ...
                            <div class="tab-pane slide-left padding-20" id="tab3">
                                <div class="row row-same-height">
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label">Driving Licence Front<span
                                                style="" class="MandatoryMarker"> *</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label">Driving Licence Back<span
                                                style="" class="MandatoryMarker"> *</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="fname" class="col-sm-2 control-label"><?php echo FIELD_DRIVERS_EXDATE; ?><span
                                                style="" class="MandatoryMarker"> *</span></label>
                                        <div class="col-sm-5">
                                            <input id="expirationrc" name="expirationrc" readonly
                            ...
                            <div class="tab-pane slide-left padding-20" id="tab4">
                                <div class="row row-same-height">
                                    ...
                                    <span id="zoneerrorbox"
                                              class="col-sm-3 control-label error-box"></span>                                       
                                <div class="col-sm-3 error-box" id="text_zone"></div>
                                </div>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div id="nextscreenHtmlNextScreen">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label id="account_number_label">Address </label> <input
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label id="account_number_label">State</label> <input
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <label for="fname" class="col-sm-3 control-label">ID
                                                                PROOF</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <button style="width: 130px;"
                                                                    ...
                                                                    id="addBankAcc">VERIFY ACCOUNT</button>
                                                        </div>
                                                    </div>
...
<script
src="<?php echo base_url(); ?>theme/intl-tel-input-master/build/js/intlTelInput.js"></script>
<script type="text/javascript"
src="http://maps.google.com/maps/api/js?key=AIzaSyCK5bz3K1Ns_BASkAcZFLAI_oivKKo98VE&sensor=false&libraries=places&language=en-AU"></script>
