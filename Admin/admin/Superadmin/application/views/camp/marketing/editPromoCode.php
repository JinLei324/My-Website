 ...
 /*chages start*/
    // Ajax to fill the form 
            ...
            $.ajax({
             ...
             // form fill 
             $.ajax({
                url: "<?php echo APILink ?>" + 'promoCodeById/' + "<?php echo $campaignId ?>" ,
                type: "GET",
                dataType: "JSON",
                headers: {
                      language: 0
              ...
              var promodata=json["data"][0];
               ...
               if (json.message == "Success") {
                   console.log('pass 3');
                    ...
                    $('#Promocode').val(promodata["code"]);
                    $('#minimumPurchaseValue').val(promodata["minimumPurchaseValue"]);
                ...
                //    changes end *****
                    ...
                    if(promodata["paymentMethod"]==1){                      
                        $('#cardselected').prop('checked', true);                       
                    }else if(promodata["paymentMethod"]==2){                       
                        $('#cashselected').prop('checked', true);                       
                    }else if(promodata["paymentMethod"]==3){                       
                        $('#bothselected').prop('checked', true);                       
                    }else if(promodata["paymentMethod"]==4){                      
                        $("input[name=xridesRadio][value='4']").prop("checked",true);
                    }
                    ...
                    //applicBLE type
                    if(promodata["applicableOn"]==1){                  
                    $("input[name=applicableOn]").val([1]);
                    }else if(promodata["applicableOn"]==2){                  
                        $("input[name=applicableOn]").val([2]);
                    }else if(promodata["applicableOn"]==3){                      
                        $("input[name=applicableOn]").val([3]);
                    }
                   ...
                   var dataterms=promodata["termsAndConditions"];
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20"><br/>
                <div class="inner" style="">
                    ...
                    <ul class="breadcrumb" style="">
                        ...
                        <li class="breadClass"><a href="<?php echo base_url() ?>index.php?/CouponCode/index/1" class="active">PROMO CODE</a>&nbsp>&nbsp<a href="<?php echo base_url() ?>index.php?/couponCode/addNewCode" style="color: #0090d9 !important; font-size: 11px !important">EDIT PROMO CODE</a>
                        </li>
                        <p class="pull-right cls110 submitButtonCss">
                             <button class="btn btn-primary btn-cons m-b-10 postAOffer texttop" type="button" style="border-radius: 40px;">
                        ...
                        <div class="panel-collapse " id="collapseOne" style="height: 0px;">
                                ...
                                <div class="col-md-12 col-md-12 b-b b-t b-l b-r b-grey p-b-10 p-t-10 ">
                                    <div class="col-sm-6 form-group">
                                        <div class="form-group removePadding">
                                            <label for="fname" class="col-sm-3 control-label aligntext">CODE <span class="mandatoryField"> &nbsp *</span></label>
                                            <div class="col-sm-7">
                            ...
                            <div class="col-md-12 col-md-12 b-b b-t b-l b-r b-grey p-b-10 p-t-10 ">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="radio radio-success">
                                                    <input class = "marginLeft" type="radio"  value="1" name="xridesRadio" id="cardselected">
                                                    <label>CARD</label>
                                                    ...
                                                    <label>ANY</label>
                                                    <!-- <input type="radio" class="marginLeft"  value="4" name="xridesRadio" id="bothselected">
                                 ...
                                 <div class="col-md-12 col-md-12 b-b b-t b-l b-r b-grey p-b-10 p-t-10 ">
                                    <div class="col-sm-6 removePadding">
                                        <!-- <div class="form-group ">
                                            <label class="col-sm-3 control-label aligntext">VEICHLE TYPE <span class="mandatoryField"> &nbsp *</span></label>
                                            <div class="col-sm-9">
                                                <div class="radio radio-success">
                                ...
                                <!-- Applicable on tab -->
                                  ...
                                  <div class="col-md-12 col-md-12 b-b b-t b-l b-r b-grey p-b-10 p-t-10 ">
                                    <div class="col-sm-6 removePadding">
                                        <div class="form-group ">
                                            <label class="col-sm-3 control-label aligntext" style="font-size: 11px !important;">APPLICABLE ON<span class="mandatoryField"> &nbsp *</span></label>
                                            <div class="col-sm-9">
                                                <div class="radio usageType">
                                                    <input class = "marginLeft" type="radio" name="applicableOn"  value="1" name="usageType" id="cartSelected">
                                                    <label>CART</label>
                                ...
                                <div class="col-md-12 b-b  b-l b-r b-grey p-b-10 p-t-10" style="padding-bottom: 15px">
                                    <div class="col-sm-6 removePadding">
                                        <div class="form-group ">
                                            <label class="col-sm-3 control-label aligntext1">MINIMUM PURCHASE VALUE<span class="mandatoryField"> &nbsp *</span></label>
                                            <div class="col-sm-9">
                                ...
                                <div class="col-md-12 col-md-12 b-b b-t b-l b-r b-grey p-b-10 p-t-10 ">
                                    <div class="col-sm-6 removePadding">
                                        <div class="form-group  col-xs-12 ">
                                            <label for="fname" class="col-sm-3 control-label amountLabel aligntext" style="margin-left: 3%; margin-right: -4%;">AMOUNT<span class="mandatoryField"> &nbsp *</span></label>
                                                <div class="col-sm-7">
                                ...
                                <div class="col-md-12 col-md-12 b-b b-t b-l b-r b-grey p-b-10 p-t-10 ">
                                    <div class="col-sm-6">
                                        <div class="form-group maxDiscount" style="display:none">
                                            <label for="fname" class="col-sm-3 control-label aligntext" style="font-size: 11px; padding-bottom: 10px;">MAX DISCOUNT<span class="mandatoryField"> &nbsp *</span></label>
