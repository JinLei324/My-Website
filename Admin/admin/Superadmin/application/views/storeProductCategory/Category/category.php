...
//                var condition = {MONGO_id: val};
                $("#confirmed").click(function () {
                    ...
                    $.ajax({
                        url: "<?php echo base_url('index.php?/ProductCategory') ?>/operationCategory/delete",
                        type: "POST",
                        data: {val: val},
                        dataType: 'json',
                        success: function (response)
                        {
                            ...
                            var settings = {
                                ...
                                "bProcessing": true,
                                "bServerSide": true,
                                "sAjaxSource": '<?php echo base_url() ?>index.php?/ProductCategory/operationCategory/table/' + status,
                                "bJQueryUI": true,
       ...
       $(document).on('change', '#editcommissionCheck', function ()
        {
            ...
            if ( $(this).is(':checked')){
                ...
                $("#editcommissionText").show()
            }else{
                
                
                $("#editcommissionText").hide()
            }

        });

        $(document).on('change', '#commissionCheck', function ()
        {
        ...
        $('#insert').click(function () {
            ...
            if ($('#catname_0').val() == "" || $('#catname_0').val() == null)
            {
            ...
            } else if($("#commissionCheck").is(':checked') && ($('#commission').val() == "" || $('#commission').val() == null)){
                $('#categoryError').text("Please type the commission value.")
            }else if (val.length == 1 || val.length > 1) {
                $('#displayData').modal('show');
                $('#display-data').text('Invalid Selection')
            } else {
                ...
                if($("#commissionCheck").is(':checked')){
                    console.log("commissionChecked")
                    form_data1.append('commissionEnable','1');
                    console.log('commissionValue',$('#commission').val())
                    form_data1.append('commissionValue',$('#commission').val());
                }else{
                    console.log("commissionUnChecked")
                    form_data1.append('commissionEnable','0');
                    form_data1.append('commissionValue','0');
                }
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (result) {
                            ...
                            $.ajax({
                                url: "<?php echo base_url('index.php?/ProductCategory/operationCategory') ?>/insert",
                                type: 'POST',
                                data: form_data1,
                                dataType: 'JSON',
                                success: function (response)
                                {
                                    if (response.msg == 1) {
                                        ...
                                        var settings = {
                                            ...
                                            "bProcessing": true,
                                            "bServerSide": true,
                                            "sAjaxSource": '<?php echo base_url() ?>index.php?/ProductCategory/operationCategory/table/0',
                                            "bJQueryUI": true,
                                            "sPaginationType": "full_numbers",
                                            "iDisplayStart ": 20,
...
//                                        });
        ...
        $(document).on('click', '#btnedit', function () {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>index.php?/ProductCategory/operationCategory/get",
                type: 'POST',
                data: {val: editVal},
                dataType: 'JSON',
                success: function (response)
...
<?php } ?>
                        ...
                        console.log("commissionEnable",row.commissionEnable);
                        console.log("commissionValue",row.commissionValue);
                        if(row.commissionEnable=='1'){
                            console.log("checkhandler");
                            $("#editcommissionCheck").attr('checked',true);
                            $('#editcommissionText').show();
                            $('#editcommission').val(row.commissionValue);
                        }else{
                            $("#editcommissionCheck").attr('checked',false);
                            $('#editcommissionText').hide();
                            $('#editcommission').val('');
                        }
        ...
        $('#editbusiness').click(function () {
            ...
            }else if($("#editcommissionCheck").is(':checked') && ($('#editcommission').val() == "" || $('#editcommission').val() == null)){
                $('#editclearerror').text("Please type the commission value.")
            } else {

                var imgUrl = '';
                var img = '';
                if($("#editcommissionCheck").is(':checked')){
                    console.log("commissionChecked")
                    form_data1.append('commissionEnable','1');
                    console.log("commissionValue",$('#editcommission').val())
                    form_data1.append('commissionValue',$('#editcommission').val());
                }else{
                    console.log("commissionUnChecked")
                    form_data1.append('commissionEnable','0');
                    form_data1.append('commissionValue','0');
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            if (result) {
                                ...
                                $.ajax({
                                    url: "<?php echo base_url('index.php?/ProductCategory/operationCategory') ?>/edit",
                                    type: 'POST',
                                    data: form_data1,
                                    dataType: 'JSON',
                                    success: function (response)
        ...
        $("#btnHide").click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>index.php?/ProductCategory/operationCategory/hide",
                type: "POST",
                data: {val: val},
                dataType: 'json',
                success: function (response)
        ...
        $("#btnUnhide11").click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>index.php?/ProductCategory/operationCategory/unhide",
                type: "POST",
                data: {val: val},
                dataType: 'json',
                success: function (response)
...
//        });
    ...
    function moveDown(id) {
        ...
        if (curr_id == undefined) {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>index.php?/ProductCategory/operationCategory/order",
                type: "POST",
...
//        });
    ...
    function validatecat() {
        $.ajax({
            url: "<?php echo base_url() ?>index.php?/ProductCategory/operationCategory/validate",
            type: "POST",
...
<script type="text/javascript">
	...
	$('#btnReject').prop('disabled', true);
		...
		$('#btnApprove').click(function(){
			...
			$.ajax({
            url: "<?php echo base_url() ?>index.php?/ProductCategory/operationCategory/approve",
            type: "POST",
            data: {val:val},
            dataType: "JSON",
            success: function (result) {
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url() ?>index.php?/ProductCategory/operationCategory/table/'+ statusChunks,
            "bJQueryUI": true,
            "sPaginationType": "full_numbers",
            "iDisplayStart ": 20,
		...
		$('#btnReject').click(function(){
            ...
            var statusChunks = urlChunks[urlChunks.length - 1];
			$.ajax({
            url: "<?php echo base_url() ?>index.php?/ProductCategory/operationCategory/reject",
            type: "POST",
		...
		$('#btnBan').click(function(){
            ...
            var statusChunks = urlChunks[urlChunks.length - 1];
			$.ajax({
            url: "<?php echo base_url() ?>index.php?/ProductCategory/operationCategory/ban",
            type: "POST",
            data: {val:val,reason:reason},
            dataType: "JSON",
            success: function (result) {
...
<div class="page-content-wrapper"style="padding-top: 20px;">
    ...
    <div class="content">
        ...
        <div class="brand inline" style="  width: auto; margin-left: 8px;padding-top: 20px;">
            <strong style="color:#0090d9;font-size: 16px;">Store Product Categories</strong>
        </div>

        <ul class="nav nav-tabs nav-tabs-fillup  bg-white whenclicked">

            <li id= "0" class="tabs_active " style="cursor:pointer">
                <a  class="changeMode" data="index.php?/ProductCategory/operationCategory/table/0"><span>Pending Approval</span></a>
            </li>
            <li id= "1" class="active tabs_active" style="cursor:pointer">
                <a  class="changeMode" data="index.php?/ProductCategory/operationCategory/table/1"><span>Approved</span></a>
            </li>
            <!-- <li id= "3" class="tabs_active" style="cursor:pointer">
                <a  class="changeMode" data="index.php?/ProductCategory/operationCategory/table/3"><span>Rejected</span></a>
            </li>
            <li id= "4" class="tabs_active" style="cursor:pointer">
                <a  class="changeMode" data="index.php?/ProductCategory/operationCategory/table/4"><span>Banned</span></a>
            </li> -->
            <li id= "2" class="tabs_active" style="cursor:pointer">
                <a   class="changeMode" data="index.php?/ProductCategory/operationCategory/table/2"><span>Deleted</span></a>
            </li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-body">
                    ...
                    <div class="categoryCommission">
                        <div class="row">
                            <div class="form-group" class="formex">
                                <div class="col-sm-1 "></div>
                                <label class="col-sm-4 control-label">Commission</label>
                                <div class="col-sm-6">
                                    <input id="commissionCheck"  class="cmn-toggle cmn-toggle-round" type="checkbox" style="display: none;" >
                                    <label for="commissionCheck"></label>
                                    <div id="commissionText" style="display:none">
                                        
                                        <input type="text" class="form-control error-box-class" id="commission" name="commission"  minlength="3" placeholder="Enter Commission Value" required=""> 
                                    </div>
                                </div>
                            </div>
                        </div>      
                    ...
                    <div class="row">
                        <div class="form-group" class="formex">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div id="editcommissionText" style="display:none">
                                    
                                    <input type="text" class="form-control error-box-class" id="editcommission" name="commission"  minlength="3" placeholder="Enter Commission Value" required="">  
