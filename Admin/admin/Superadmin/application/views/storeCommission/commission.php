...
<script>
    ...
    $(document).ready(function () {
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url() ?>index.php?/storeCommission/commission_details/0',
            "bJQueryUI": true,
        ...
        $("#yesAdd").click(function () {
            ...
            if (storeId == '' || storeId == null) {
                ...
                $.ajax({
                    url: "<?php echo base_url('index.php?/storeCommission') ?>/addCommission",
                    type: "POST",
                    dataType: 'json',
...
//        $('#edit').click(function () {
        ...
        $(document).on('click','#btnEdit',function () {
           editval = $(this).val()
                ...
                $.ajax({
                    url: "<?php echo base_url('index.php?/storeCommission') ?>/getCommissionData",
                    type: "POST",
                    dataType: 'json',
                    data: {Id: editval},
                    success: function (result) {
                        ...
                        $('#editstoreid').val(result.data._id.$oid);
        ...
        $("#yesEdit").click(function () {
            ...
            var storeId = $('#editstoreid option:selected').val();
            var storeName = $('#editstoreid option:selected').attr('data-name');
            ...
            if (storeId == '' || storeId == null) {
                ...
                $.ajax({
                    url: "<?php echo base_url('index.php?/storeCommission') ?>/editCommission",
                    type: "POST",
                    data: {commId: editval,
        ...
        $('#reset').click(function () {
            ...
            if (val.length == 1) {
                $.ajax({
                    url: "<?php echo base_url('index.php?/storeCommission') ?>/setDefaultCommission",
                    type: "POST",
                    dataType: 'json',
        ...
        <div class="panel panel-transparent ">
            ...
            <!--            <ul class="nav nav-tabs  bg-white whenclicked">
                            <li id= "my1" class="tabs_active active" style="cursor:pointer">
                                <a  class="changeMode accepted_" data="<?php echo base_url(); ?>index.php?/storeCommission/commission_details/0" data-id="1"><span><?php echo $this->lang->line('heading_active'); ?></span><span class="badge" style="background-color: #337ab7;"></span></a>
                            </li>
            
                            <li id= "my2" class="tabs_active" style="cursor:pointer">
                                <a  class="changeMode rejected_" data="<?php echo base_url(); ?>index.php?/storeCommission/commission_details/1" data-id="2"><span><?php echo $this->lang->line('heading_deactive'); ?></span> <span class="badge bg-red"></span></a>
                            </li>
                        </ul>-->
            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="fname" class="col-sm-3 control-label"><?php echo $this->lang->line('lable_Store'); ?><span style="" class="MandatoryMarker"> *</span></label>
                        <div class="col-sm-8">
                            <select id="editstoreid" name="editstoreid"  class="form-control error-box-class">
                                <option data-name="Select Store" value=""><?php echo $this->lang->line('label_SelectStore'); ?></option>
                            ...
                            <input type="hidden" name="editstoreName" id="editstoreName" value="" />
                        </div>
