        ...
        <div class="panel panel-transparent ">
            ...
            <ul class="nav nav-tabs  bg-white whenclicked">
                ...
                <li id= "my2" class="tabs_active" style="cursor:pointer">
                    <a  class="changeMode rejected_" data="<?php echo base_url(); ?>index.php?/CentralController/tax_details/2" data-id="2"><span><?php echo $this->lang->line('heading_deactive'); ?></span> <span class="badge bg-red"></span></a>
                </li>
                <li id= "my3" class="tabs_active" style="cursor:pointer">
                    <a  class="changeMode deleted_" data="<?php echo base_url(); ?>index.php?/CentralController/tax_details/3" data-id="3"><span><?php echo $this->lang->line('heading_deleted'); ?></span> <span class="badge bg-red"></span></a>
                </li>
            </ul>
            <ul class="nav nav-tabs nav-tabs-simple whenclicked bg-white new_button" style="" role="tablist" data-init-reponsive-tabs="collapse">
                ...
                <div class="pull-right m-t-10"> <button class="btn btn-info cls111" id="delete"><?php echo $this->lang->line('button_delete'); ?></button></div>
                <div class="pull-right m-t-10"><a href="<?php echo base_url() ?>index.php?/CentralController/addCentral"> <button class="btn btn-success pull-right m-t-10 cls110" id="addsentral"><?php echo $this->lang->line('button_add'); ?> </button></a></div>
