...
<style>
 ...
 .bootstrap-timepicker-widget table td input{
    ...
    #addVoucher .bootstrap-timepicker {
    margin-top:5px;
}
}
 ...
 $(document).ready(function () {
    ...
    $('.changeMode').click(function () {   
       ...
       $('.tabs_active').removeClass('active');
        ...
        var urlChunks = $("li.active.tabactive").find('.changeMode').attr('data').split('/');
       ...
       var offset = new Date().getTimezoneOffset();
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url() ?>index.php?/Voucher/voucher_details/'+offset+'/'+status,
            "bJQueryUI": true,
   ...
   $("body").on('click', '#confirmDeativate', function (){        
    ...
    function updateCampaignStatus(couponIds, status){
            $.ajax({
                    // change API link
                    url: "<?php echo base_url('index.php?/Voucher/updatecouponCodeStatus');?>",
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        offerId : couponIds,
...
<script>
    ...
    console.log('pass2');
        ...
        $("#yesAdd").click(function () {
            ...
            var expiryDate1 = $('#expiryDate').val();
            ...
            else if (noofcoupon == '' || noofcoupon == null || noofcoupon < 1 || isNaN(noofcoupon)) {
                $('#noofcoupon').focus();
            ...
            else if(expiryDate1== '' || expiryDate1 == null){
    ...
    <div class="content">
        ...
        <div class="panel panel-transparent ">
            <!-- Nav tabs -->
                ...
                <ul class="nav nav-tabs  bg-white whenclickedtab">
                    <li id= "my1" class="tabs_active active tabactive" style="cursor:pointer">
                        <a  class="changeMode accepted_" data="<?php echo base_url(); ?>index.php?/Voucher/voucher_details/1" data-id="1"><span><?php echo $this->lang->line('heading_active'); ?></span><span class="badge" style="background-color: #337ab7;"></span></a>
                    </li>
    
                    <li id= "my2" class="tabs_active tabactive" style="cursor:pointer">
                        <a  class="changeMode rejected_" data="<?php echo base_url(); ?>index.php?/Voucher/voucher_details/2" data-id="2"><span><?php echo $this->lang->line('heading_deactive'); ?></span> <span class="badge bg-red"></span></a>
                    </li>
                </ul>
            <ul class="nav nav-tabs nav-tabs-simple  bg-white new_button" style="" role="tablist" data-init-reponsive-tabs="collapse">
            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-xs-12">
                        <label for="fname" class="col-xs-12 col-sm-3 control-label"><?php echo $this->lang->line('lable_Voucher'); ?><span style="" class="MandatoryMarker"> *</span></label>
                    ...
                    <div class="form-group col-xs-12">
                    <label for="codeprefix" class="col-xs-12 col-sm-3 control-label"><?php echo $this->lang->line('lable_codeprefix'); ?><span style="" class="MandatoryMarker"> *</span></label>
                        <div class="col-xs-12 col-sm-8">
                    ...
                    <div class="form-group col-xs-12">
                        <label for="codepostfix"  class="col-xs-12 col-sm-3 control-label "><?php echo $this->lang->line('label_codepostfix'); ?><span class="MandatoryMarker">*</span></label>
                        <div class="col-xs-12 col-sm-8">
                    ...
                    <div class="form-group col-xs-12">
                        <label for="count"  class="col-xs-12 col-sm-3 control-label "><?php echo $this->lang->line('label_noofcoupon'); ?><span class="MandatoryMarker">*</span></label>
                        <div class="col-xs-12 col-sm-8">
                    ...
                    <div class="form-group col-xs-12">
                        <label for="value"  class="col-xs-12 col-sm-3 control-label "><?php echo $this->lang->line('label_Value'); ?><span class="MandatoryMarker">*</span></label>
                        <div class="col-xs-12 col-sm-8">
                    ...
                    <div class="form-group col-xs-12">
                        <label for="value"  class="col-xs-12 col-sm-3 control-label "><?php echo $this->lang->line('label_ExpiryDate'); ?><span class="MandatoryMarker">*</span></label>
                        ...
                        <div class="col-xs-12 col-sm-4 bootstrap-timepicker">
