...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#city_select').change(function () {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>index.php?/superadmin/getStoreDataBasedOnCity",
                type: "POST",
                data: {cityId: cityId},
                dataType: "JSON",
                async: false,
                success: function (result) {
				   ...
				   var html5 = '<option value="" >Select store</option>';
                          $.each(result.data, function (index, row) {
                               ...
                               html5 += '<option value="'+row._id.$oid+'" storeName="'+row.sName.en+'">'+row.sName.en+'</option>     ';
        ...
        $.ajax({
                url: "<?php echo base_url(); ?>index.php?/superadmin/getZonesBasedOnStores",
                type: "POST",
...
//validations for each previous tab before proceeding to the next tab
    ...
    function profiletab(litabtoremove, divtabtoremove)
    {
       ...
       {
           $("#ve_store1").text('Please select a city');
           pstatus = false;
       } else
           if (store_select == "" || store_select == null)
       {
...
<div class="page-content-wrapper">
    ...
    <ul class="breadcrumb" style="margin-left: 0px; margin-top: 5%;">
        <li><a
                href="<?php echo base_url(); ?>index.php?/superadmin/storeDrivers/my/1"
                ...
                <div id="rootwizard" class="m-t-50">
                    ...
                    <ul
                        ...
                        <li class="tabs_active" id="fourthlitab"><a data-toggle="tab"
                                    ...
                                    id="tab4icon" class=""></i> <span>SERVICE ZONES</span></a></li>
...
<input type="hidden" id="driverType" value="3" name="driverType" required="required" class="form-control">
...
//                                                }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3 error-box" id="ve_store1"></div>
                                                                       ...
                                                                       <div class="form-group"> 
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                ...
                                                                                <input type="hidden" id="storeName" name="storeName" required="required" class="form-control">
                                                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" id="dob" name="dob" required="required" readonly
