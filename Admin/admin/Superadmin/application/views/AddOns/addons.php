                            ...
                            <div class="panel panel-transparent">
                                <div class="panel-heading">
                                    ...
                                    <div class="searchbtn row clearfix pull-right" style="margin-right: 0%;">
                                        ...
                                        <div class=""><input type="text" id="search-table" class="form-control pull-right" style="text-transform: capitalize;margin-bottom:6px" placeholder="<?php echo SEARCH; ?>"> </div>
                                    </div>
                                    <div class="dltbtn">
                                    </div>
                                </div>
