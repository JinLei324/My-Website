        ...
        switch ($driverType) {
            ...
            case '':
                if ($plan == '') {
                    ...
                    $data['Approved'] = $this->mongo_db->where(array('driverType' => 3, 'status' => array('$in' => [2, 3, 4, 8, 9])))->count('driver');
                    $data['Accepted'] = $this->mongo_db->where(array('driverType' => 3, 'status' => array('$in' => [3, 4])))->count('driver');
                    $data['Inactive'] = $this->mongo_db->where(array('driverType' => 3, 'status' => array('$in' => [2, 7])))->count('driver');
                    $data['Rejepted'] = $this->mongo_db->where(array('driverType' => 3, 'status' => 6))->count('driver');
                    $data['Banned'] = $this->mongo_db->where(array('driverType' => 3, 'status' => 7))->count('driver');
                    $data['Online'] = $this->mongo_db->where(array('driverType' => 3, 'status' => 3))->count('driver');
                    $data['offline'] = $this->mongo_db->where(array('driverType' => 3, 'status' => 4))->count('driver');
                    $data['loggedOut'] = $this->mongo_db->where(array('driverType' => 3, 'status' => 8))->count('driver');
                    $data['timedOut'] = $this->mongo_db->where(array('driverType' => 3, 'status' => 9))->count('driver');
                } else {
...
//        $_POST['mDataProp_0'] = "sl";
    ...
    function updateAppConfigNew() {
        ...
        $dispatch_settings = array('dispatchMode' => (int) $this->input->post('dipatchModeValue'),
         ...
         'delayDisplayTime' => (int) $this->input->post('delayDisplayTime')  
        );
...
//                        case '3':
//                            if ($store == '') {
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => 9, 'driverType' => 3), 'mobileDevices.lastISOdate', -1);
//                            } else {
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => 9, 'driverType' => 3, 'storeId' => new MongoDB\BSON\ObjectID($store)), 'mobileDevices.lastISOdate', -1);
//                            }
//
//                            break;
                    }
...
//                        case '3':
//                            if ($store == '') {
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => 1, 'driverType' => 3));
//                            } else {
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => 1, 'driverType' => 3, 'storeId' => new MongoDB\BSON\ObjectID($store)));
//                            }
//                            break;
                    }
                    break;
...
//                        case '3':
//                            if ($store == '') {
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => array('$in' => [3, 4]), 'driverType' => 3));
//                            } else {
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => array('$in' => [3, 4]), 'driverType' => 3, 'storeId' => new MongoDB\BSON\ObjectID($store)));
//                            }
//
//                            break;
                    }
...
//                        case '3':
//                            if ($store == '')
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => 6, 'driverType' => 3));
//                            else
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => 6, 'driverType' => 3, 'storeId' => new MongoDB\BSON\ObjectID($store)));
//
//                            break;
                    }
                    break;
...
//                        case '3':
//                            if ($store == '')
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => 7, 'driverType' => 3));
//                            else
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => 7, 'driverType' => 3, 'storeId' => new MongoDB\BSON\ObjectID($store)));
//
//                            break;
                    }
                    break;
...
//                        case '3':
//                            if ($store == '')
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => array('$in' => [2, 7]), 'driverType' => 3));
//                            else
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => array('$in' => [2, 7]), 'driverType' => 3, 'storeId' => new MongoDB\BSON\ObjectID($store)));
//
//                            break;
                    }
                    break;
...
//                        case '3':
//                            if ($store == '')
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => array('$in' => [2, 3, 4, 8, 9]), 'driverType' => 3));
//                            else
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => array('$in' => [2, 3, 4, 8, 9]), 'driverType' => 3, 'storeId' => new MongoDB\BSON\ObjectID($store)));
//
//                            break;
                    }
                    break;
...
//                        case '3':
//                            if ($store == '') {
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => 3, 'driverType' => 3));
//                            } else {
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => 3, 'driverType' => 3, 'storeId' => new MongoDB\BSON\ObjectID($store)));
//                            }
//
//                            break;
                    }
...
//                        case '3':
//                            if ($store == '') {
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => 8, 'driverType' => 3));
//                            } else {
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => 8, 'driverType' => 3, 'storeId' => new MongoDB\BSON\ObjectID($store)));
//                            }
//
//                            break;
                    }
...
//                        case '3':
//                            if ($store == '') {
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => 4, 'driverType' => 3));
//                            } else {
//                                $respo = $this->datatables->datatable_mongodb('driver', array('status' => 4, 'driverType' => 3, 'storeId' => new MongoDB\BSON\ObjectID($store)));
//                            }
//
//
//                            break;
