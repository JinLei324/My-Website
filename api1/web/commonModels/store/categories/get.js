    ...
    storeCategory.getStoreCategories({
        ...
        if (result.length > 0) {
            for (var j = 0; j < result.length; j++) {
                ...
                result[j].description = "abc";
                result[j].bannerImage = result[j].backgroundImage ? result[j].backgroundImage : "";
                result[j].logoImage = result[j].backgroundImage ? result[j].backgroundImage : "";
                result[j].iconlogoimg = result[j].backgroundImage ? result[j].backgroundImage : "";
