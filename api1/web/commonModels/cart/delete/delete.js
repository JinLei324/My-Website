...
const handler = (request, reply) => {
    ...
    if(request.params.orderType && request.params.orderType == 2){
        request.params.unitId = parseInt(request.params.unitId)
        request.params.childProductId = parseInt(request.params.childProductId) 
    }
