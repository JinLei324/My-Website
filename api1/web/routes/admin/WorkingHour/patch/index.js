...
/** @namespace */
const workingHourPatch = require('./patch');
    ...
    */
    {
        ...
        config: {
            ...
            //     status: {
            //         200: {
            //             message: error['getData']['200'], data: Joi.any().example({})
            //         },
        ...
        /** @memberof manager */
        handler: workingHourPatch.handler,
    }
]
