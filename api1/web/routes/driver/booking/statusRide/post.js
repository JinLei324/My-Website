    ...
    return new Promise((resolve, reject) => {
      ...
      if (dataToUpdate["accouting.storeCommissionType"] == 0) {
        ...
        dataToUpdate["accouting.storeCommissionToAppValue"] =
          ((100 - dataToUpdate["accouting.storeCommPer"]) / 100) *
          (dataToUpdate["accouting.cartTotalWithoutOfferPrice"] + dataToUpdate["accouting.excTax"]);
        dataToUpdate["accouting.storeEarningValue"] =
          (dataToUpdate["accouting.storeCommPer"] / 100) *
          (dataToUpdate["accouting.cartTotalWithoutOfferPrice"] + dataToUpdate["accouting.excTax"]);
      } else {
        // fixed
        dataToUpdate["accouting.storeCommissionToAppValue"] = dataToUpdate["accouting.storeCommPer"];
        dataToUpdate["accouting.storeEarningValue"] =
          dataToUpdate["accouting.cartTotalWithoutOfferPrice"] +
          dataToUpdate["accouting.excTax"] -
          dataToUpdate["accouting.storeCommissionToAppValue"];
      }
